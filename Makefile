...
static-analysis: build
		...
		$(DOCKER) clang-tidy $(CPPFILES) --checks="*,-fuchsia-*, -cert-err58-cpp, -altera-unroll-loops, -altera-struct-pack-align, -hicpp-use-nullptr, -modernize-use-nullptr, -readability-magic-numbers, -llvm*, -modernize-use-trailing-return-type, -cppcoreguidelines-avoid-magic-numbers, -modernize-use-nodiscard, -readability-named-parameter, -hicpp-named-parameter" --warnings-as-errors="*" -- -Icommon -std=c++20
